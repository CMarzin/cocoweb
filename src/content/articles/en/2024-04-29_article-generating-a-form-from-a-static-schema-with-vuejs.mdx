...
If you want to skip directly to the code, you can view the code <BaseLink text="CMarzin/form-generator" url="https://github.com/CMarzin/form-generator" />.


<div class="nested-toc [&_a]:text-primary [&_a]:underline-offset-2 [&_a]:hover:underline mt-5">
  <ol>
    <li>
      <a href="#1-create-the-config-file">Create the config file</a>
      <ol>
        <li><a href="#11-import-your-components">Import your components</a></li>
        <li><a href="#12-list-the-name-of-your-inputs">List the name of your inputs</a></li>
        <li><a href="#13-type-your-config">Type your config</a></li>
        <li><a href="#14-write-your-config">Write your config</a></li>
      </ol>
    </li>
    <li>
      <a href="#2-create-a-file-for-using-the-config">Create a file for using the config</a>
      <ol>
        <li><a href="#11-import-your-config">Import your config</a></li>
        <li><a href="#12-create-a-shell-of-the-form-data">Create a shell of the form data</a></li>
        <li><a href="#13-create-your-form-schema">Create your form schema</a></li>
      </ol>
    </li>
    <li>
      <a href="#3-use-your-schema">Use your schema</a>
    </li>
  </ol>
</div>
...
Create a file for using the config
</h3>
...
<h4 class="mt-5">
<span class="font-bold">1.2</span>
Create a shell of the form data
</h4>
...
If you want to pass the superior level, I invite you to check <BaseLink text="FormKit ⚡️ The open-source form framework for Vue" url="https://formkit.com/" />.

For a better schema validation you can check <BaseLink text="Valibot" url="https://valibot.dev/" /> or <BaseLink text="Zod" url="https://zod.dev/" />